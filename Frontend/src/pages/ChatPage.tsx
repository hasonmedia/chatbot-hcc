            ...
            <Card className="w-full">
                <CardHeader className="pb-3 sm:pb-4">
                    ...
                    <CardDescription className="text-xs sm:text-sm">
                        {currentSessionInfo?.status === "false" && currentSessionInfo?.time ? (
                            <Countdown
                                ...
                                {isLoadingSessions ? (
                                    ...
                                    filteredSessions.map((session) => (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`${isSessionSelectionMode &&
                        ...
                        <div className="shrink-0 flex h-14 items-center justify-between border-b p-3 bg-white z-10">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <h3 className="text-sm sm:text-base lg:text-lg font-semibold truncate">
                                    {currentSessionInfo
                                        ? `Phiên: ${currentSessionInfo.customer_name ||
                                    ...
                                    <Button
                                        ...
                                        onClick={async () => {
                                            try {
                                                ...
                                                toast.error("Mở chặn bot thất bại. Vui lòng thử lại.");
                                            }
                                        }}
                            ...
                            <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                                {isLoadingMessages ? (
                                    ...
                                    messages.map((msg, index) => (
                                        <div
                                            key={msg.id || index}
                                            className={`relative min-w-0 ${isSelectionMode ? "cursor-pointer" : ""
                                                }`}
                                            onClick={() => {
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute right-2 sm:right-3 top-2 sm:top-3 flex gap-1 sm:gap-2">
                                        ...
                                        <Button
                                            ...
                                            className="h-8 w-8 sm:h-9 sm:w-9"
                                            title={`Chọn ảnh (tối đa 500KB/ảnh, ${5 - selectedImages.length
                                                } ảnh còn lại)`}
                                        >
